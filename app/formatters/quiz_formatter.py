    ...
    def generate_quiz(self, report: SynthesizedRepositoryReport) -> Dict[str, Any]:
        ...
        if report.milestones:
            ...
            questions.append({
                ...
                "explanation": f"In topological sequence reasoning, Milestone 0 represents starting leaf nodes that can be understood in isolation without prior knowledge of the rest of the codebase.",
            })
        ...
        if cyclic_milestone:
            questions.append({
                ...
                "explanation": "Strongly connected components (SCCs) have mutual return edges and cannot be ordered ordinally without tie-breaking heuristics. They are best understood together as a subsystem.",
            })

        # Question 3: Domain Distribution
